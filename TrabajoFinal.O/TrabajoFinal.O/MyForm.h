...
namespace TrabajoFinalO {
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->radioButton2->Location = System::Drawing::Point(538, 484);
			...
			this->button4->Location = System::Drawing::Point(490, 507);
			...
			this->button3->Text = L"Filtrar  Columnas por Nombres";
			...
			this->listBox1->Size = System::Drawing::Size(416, 498);
			...
			this->rButtNombre->Size = System::Drawing::Size(62, 17);
			this->rButtNombre->TabIndex = 21;
			this->rButtNombre->TabStop = true;
			this->rButtNombre->Text = L"Nombre";
			this->rButtNombre->UseVisualStyleBackColor = true;
			// 
			// rButtTam
			// 
			...
			this->rButtTam->Size = System::Drawing::Size(64, 17);
			this->rButtTam->TabIndex = 22;
			this->rButtTam->TabStop = true;
			this->rButtTam->Text = L"Tamaño";
			this->rButtTam->UseVisualStyleBackColor = true;
			// 
			// rButtExtension
			// 
			...
			this->rButtFecha->Size = System::Drawing::Size(55, 17);
			this->rButtFecha->TabIndex = 24;
			this->rButtFecha->TabStop = true;
			this->rButtFecha->Text = L"Fecha";
			this->rButtFecha->UseVisualStyleBackColor = true;
			// 
			// label1
			// 
			this->label1->AutoSize = true;
			this->label1->BackColor = System::Drawing::SystemColors::ControlDark;
			this->label1->Location = System::Drawing::Point(434, 136);
			...
			// txtEmpieza
			// 
			this->txtEmpieza->Location = System::Drawing::Point(508, 162);
			...
			// txtCotiene
			// 
			this->txtCotiene->Location = System::Drawing::Point(508, 212);
			...
			// txtTermina
			// 
			this->txtTermina->Location = System::Drawing::Point(508, 186);
			...
			this->label4->Location = System::Drawing::Point(434, 165);
			...
			this->label5->Location = System::Drawing::Point(434, 215);
			...
			this->label6->Location = System::Drawing::Point(434, 189);
			...
			this->button1->Text = L"Filtrar  Columnas por Tamaño";
	...
	private: System::Void filtrar_c_tamaño(System::Object^  sender, System::EventArgs^  e) {
		if (txtMayor->Text != "") {
			...
			vector<string> v = this->fileExp->filtrardo_columnas_tamaño_mayor(tam);
			if (!v.empty()) {
				for (int i = 0; i < v.size(); ++i) {
					String^ n = gcnew String(v[i].c_str());
					listBox1->Items->Add(n);
